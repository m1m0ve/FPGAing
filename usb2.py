...
def write_to_adu(dev, msg_str):
    ...
    try:
        ...
        num_bytes_written = dev.write(0x04,byte_str)
...
if data != None:
    ...
    print("Received data as int: {}".format(((data)))) # the returned value is a string - we can convert it to a number (int) if we wish
